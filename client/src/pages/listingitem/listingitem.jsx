...
export default function ListingItem({listing}) {
  return (
    <div className='bg-white shadow-md  border-2 border-slate-700 hover:shadow-lg transition-shadow   overflow-hidden rounded-lg w-[110px] h-[270px] sm:w-[250px] sm:h-[460px]  '>
