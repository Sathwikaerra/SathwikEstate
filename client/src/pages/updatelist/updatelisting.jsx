...
setSuccess("List Created Succesfully")
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="flex flex-col  sm:flex-row gap-4">
      ...
      <input onChange={handleChange} type="text" placeholder='name' className='border p-3 rounded-lg ' id='name' value={formData.name} maxLength='62' minLength='4' required/>
     ...
     <div className="flex flex-col flex-1 gap-4" >
      ...
      <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-90 disabled:opacity-80' >{loading?"Updating...":"Update a Listing"}</button>
