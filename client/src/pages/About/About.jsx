...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      <h1 className='text-3xl font-bold mb-4 text-slate-800'>About Sathwik Estate</h1>
      <p className='mb-4 text-slate-700'>Sathwik Esate is a leading real estate agency that specializes in helping
        clients but,sell and rent properties in the most desirable neighbours.Our team of experience agents is dedicate to providing 
